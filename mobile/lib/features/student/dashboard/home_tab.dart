        ...
        children: [
          ...
          TextField(
            ...
            decoration: const InputDecoration(
              hintText: 'Rechercher un document, un cours…',
          ...
          SizedBox(
            ...
            child: ListView(
              ...
              children: [
                _Chip(
                  label: 'Tous',
                  selected: catalogue.selectedFiliereId == null,
                  onTap: () => catalogue.setFiliereFilter(null),
                ),
                ...catalogue.filieres.map(
                  (f) => _Chip(
                    label: f.nom,
          ...
          Row(
            children: [
              ...
              TextButton(
                onPressed: () => context
                    .findAncestorStateOfType<StudentShellState>()
                    ?.switchTab(1),
                  ...
                  (p) => AppRowCard(
                    leading: p.fullCouvertureUrl != null
                        ...
                        : const ThumbBox(
                            icon: Icons.picture_as_pdf_outlined,
                            gradient: LinearGradient(
                              colors: [Color(0xFF0B7285), Color(0xFF15AABF)],
                            ),
                          ),
                    title: p.documentTitre,
                    subtitle:
                        '${Formatters.date(p.createdAt)} · ${Formatters.currency(p.documentPrix)}',
